                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        ...
                        <div class="sort-options ml-4">
                            ...
                            <select id="sortSelect" onchange="sortProducts(this.value)" name="sortBy">
                                <option value="unsorted" <c:if test="${sortBy == 'unsorted'}">selected</c:if>>All</option>
                                <option value="discountHighLow" <c:if test="${sortBy == 'discountHighLow'}">selected</c:if>>Discount</option>
...
<div class="pagination">
    <c:forEach begin="1" end="${totalPages}" var="i">
        <a href="?service=searchByKeywords&keywords=${keywords}&sortBy=${sortBy}&pageNumber=${i}&pageSize=${pageSize}" class="${i == currentPage ? 'active' : ''}">${i}</a>
    </c:forEach>
</div>
</div>
<!-- Pagination End -->
