                    ...
                    <div class="row px-xl-5">
                        <c:if test="${showBill eq null}">
                            <div class="col-lg-8 table-responsive mb-5">
                                <button class="btn btn-block btn-primary my-3 py-3 w-25" onclick="goBack()">Back</button>
                                <table class="table table-bordered text-center mb-0">
                                    ...
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            ...
                                            <div class="input-group quantity mx-auto" style="width: 100px" >
                                                <input type="number" class="form-control form-control-sm bg-secondary text-center" value="<%= quantity%>" form="add-cart" name="p<%= id%>"/>
                                            </div>
                                    ...
                                    <% total_raw += (product.getPrice() * quantity);}} DecimalFormat df = new DecimalFormat("#.0"); String total = df.format(total_raw); %>
                                    </tbody>
                                ...
                                <button class="btn btn-block btn-primary my-3 py-3" style="float: left; width: 15%;" onclick="document.getElementById('add-cart').submit();">Update</button>
                                
                                <a href="cart?service=removeAll">
                                    <button class="btn btn-block btn-primary my-3 py-3" style="float: right; width: 15%;">Remove all</button>
                                </a>
                            </div>
                            <div class="col-lg-4">
                        ...
                        <c:if test="${showBill ne null}">
                            <div class="col-lg-8 table-responsive mb-5">
                                <h1 class="font-weight-semi-bold text-uppercase mb-3 text-center">Your Bill Here!</h1>
                                <table class="table table-bordered text-center mb-0">
                                    <thead class="bg-secondary text-dark">
                                        <tr>
                                            <th>Bill ID</th>
